...
>
	...
	>
		<div class="flex items-center gap-3">
			<div>
				<h2 class="text-slate-800 dark:text-slate-200 font-bold tracking-tight">
					Cibrid Council <span
		...
		<div class="flex items-center gap-4 text-slate-500 dark:text-slate-400">
			<div class="flex flex-col items-end">
				...
				<span class="text-xs flex items-center gap-1.5 font-medium"
					><div
						class="w-2 h-2 rounded-full {globalState.clusterState.status === 'optimal'
							? 'bg-emerald-500 dark:bg-emerald-400'
							: 'bg-amber-500 dark:bg-amber-400'} animate-pulse shadow-sm"
					></div>
					{globalState.clusterState.status === 'optimal' ? 'Online' : 'Degraded'}</span
				>
			</div>
				...
				<div class="flex items-center gap-2 mb-1.5 px-1">
					...
					<span
						class="text-[10px] uppercase font-bold tracking-widest {msg.role === 'user'
							...
							: 'text-blue-600 dark:text-[#74b0ff]'}">{msg.agent}</span
					>
					...
					>
						...
						>
							<BrainCircuit
								...
								msg.id ===
									globalState.chat.messages[globalState.chat.messages.length - 1]
										.id
									? 'animate-pulse'
									: ''}"
							/>
			...
			>
				<div class="flex items-center gap-2 overflow-hidden flex-1">
					...
					<span
						...
						>Contexto anexado: "{globalState.chat.inputContext}"</span
					>
				</div>
				<button
					type="button"
					...
					{#if showTools}
						...
						>
							...
							<button
								...
								title={globalState.chat.isCognitiveFirewallEnabled
